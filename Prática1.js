...
console.log(`Salário Líquido: ${salarioLiquido(salarioBruto,adicionalNoturno,horaExtra,descontos).toFixed(2)}`); // .toFixed() serve para ajustar a formatação de exibição.
